"""STANDARD alignment contract for returns_resolver."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "returns_resolver"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/returns_resolver/align.py"

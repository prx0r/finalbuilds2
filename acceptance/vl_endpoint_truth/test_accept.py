"""STANDARD alignment contract for vl_endpoint_truth."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "vl_endpoint_truth"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/vl_endpoint_truth/align.py"

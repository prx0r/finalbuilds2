"""STANDARD alignment contract for llm_deal_intel."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "llm_deal_intel"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/llm_deal_intel/align.py"

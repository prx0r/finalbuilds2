"""STANDARD alignment contract for verifiable_crypto_lab."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "verifiable_crypto_lab"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/verifiable_crypto_lab/align.py"

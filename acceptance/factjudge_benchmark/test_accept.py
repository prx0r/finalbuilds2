"""STANDARD alignment contract for factjudge_benchmark."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "factjudge_benchmark"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/factjudge_benchmark/align.py"

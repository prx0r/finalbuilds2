"""STANDARD alignment contract for warranty_resolver."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "warranty_resolver"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/warranty_resolver/align.py"

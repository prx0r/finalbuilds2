"""STANDARD alignment contract for r2_build_the_decision_point."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "r2_build_the_decision_point"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/r2_build_the_decision_point/align.py"

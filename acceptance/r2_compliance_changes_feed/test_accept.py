"""STANDARD alignment contract for r2_compliance_changes_feed."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "r2_compliance_changes_feed"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/r2_compliance_changes_feed/align.py"

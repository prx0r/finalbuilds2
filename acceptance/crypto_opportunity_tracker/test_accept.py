"""STANDARD alignment contract for crypto_opportunity_tracker."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "crypto_opportunity_tracker"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/crypto_opportunity_tracker/align.py"

"""STANDARD alignment contract for room_redesign."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "room_redesign"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/room_redesign/align.py"

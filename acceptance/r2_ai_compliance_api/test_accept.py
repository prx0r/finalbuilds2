"""STANDARD alignment contract for r2_ai_compliance_api."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "r2_ai_compliance_api"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/r2_ai_compliance_api/align.py"

"""STANDARD alignment contract for hackathon_scout."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "hackathon_scout"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/hackathon_scout/align.py"

"""STANDARD alignment contract for fi_agentbrowsercompiler."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "fi_agentbrowsercompiler"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/fi_agentbrowsercompiler/align.py"

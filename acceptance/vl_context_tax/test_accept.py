"""STANDARD alignment contract for vl_context_tax."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "vl_context_tax"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/vl_context_tax/align.py"

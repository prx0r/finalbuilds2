"""STANDARD alignment contract for x_entity_resolution."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "x_entity_resolution"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/x_entity_resolution/align.py"

"""STANDARD alignment contract for aletheia_freshness."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "aletheia_freshness"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/aletheia_freshness/align.py"

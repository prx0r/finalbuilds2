"""STANDARD alignment contract for domain_finder."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "domain_finder"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/domain_finder/align.py"

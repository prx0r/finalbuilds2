"""STANDARD alignment contract for r2_vent_agent_execution_compiler."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "r2_vent_agent_execution_compiler"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/r2_vent_agent_execution_compiler/align.py"

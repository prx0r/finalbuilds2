"""STANDARD alignment contract for x_multi_dim_scoring."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "x_multi_dim_scoring"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/x_multi_dim_scoring/align.py"

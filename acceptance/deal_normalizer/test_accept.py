"""STANDARD alignment contract for deal_normalizer."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "deal_normalizer"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/deal_normalizer/align.py"

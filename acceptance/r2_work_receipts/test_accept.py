"""STANDARD alignment contract for r2_work_receipts."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "r2_work_receipts"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/r2_work_receipts/align.py"

"""STANDARD alignment contract for r2_work_receipts_now_looks_strongest."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "r2_work_receipts_now_looks_strongest"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/r2_work_receipts_now_looks_strongest/align.py"

"""STANDARD alignment contract for r2_vent_machine_acquirable_deals."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "r2_vent_machine_acquirable_deals"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/r2_vent_machine_acquirable_deals/align.py"

"""STANDARD alignment contract for tool_price_oracle."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "tool_price_oracle"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/tool_price_oracle/align.py"

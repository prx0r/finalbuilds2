"""STANDARD alignment contract for redirect_chain_checker."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "redirect_chain_checker"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/redirect_chain_checker/align.py"

"""STANDARD alignment contract for iolaus_action_receipts."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "iolaus_action_receipts"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/iolaus_action_receipts/align.py"

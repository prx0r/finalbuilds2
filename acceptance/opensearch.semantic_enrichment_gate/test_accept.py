"""STANDARD alignment contract for opensearch.semantic_enrichment_gate."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "opensearch.semantic_enrichment_gate"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/opensearch.semantic_enrichment_gate/align.py"

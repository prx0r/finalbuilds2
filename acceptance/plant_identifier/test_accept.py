"""STANDARD alignment contract for plant_identifier."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "plant_identifier"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/plant_identifier/align.py"

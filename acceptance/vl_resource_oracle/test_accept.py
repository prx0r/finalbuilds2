"""STANDARD alignment contract for vl_resource_oracle."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "vl_resource_oracle"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/vl_resource_oracle/align.py"

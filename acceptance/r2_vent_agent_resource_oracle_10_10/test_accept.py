"""STANDARD alignment contract for r2_vent_agent_resource_oracle_10_10."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "r2_vent_agent_resource_oracle_10_10"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/r2_vent_agent_resource_oracle_10_10/align.py"

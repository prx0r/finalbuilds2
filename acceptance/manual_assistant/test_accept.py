"""STANDARD alignment contract for manual_assistant."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "manual_assistant"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/manual_assistant/align.py"

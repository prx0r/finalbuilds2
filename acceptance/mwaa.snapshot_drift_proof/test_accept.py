"""STANDARD alignment contract for mwaa.snapshot_drift_proof."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "mwaa.snapshot_drift_proof"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/mwaa.snapshot_drift_proof/align.py"

"""STANDARD alignment contract for buyable_by_date."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "buyable_by_date"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/buyable_by_date/align.py"

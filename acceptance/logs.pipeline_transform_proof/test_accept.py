"""STANDARD alignment contract for logs.pipeline_transform_proof."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "logs.pipeline_transform_proof"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/logs.pipeline_transform_proof/align.py"

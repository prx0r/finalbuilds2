"""STANDARD alignment contract for fi_pluginpolicy."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "fi_pluginpolicy"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/fi_pluginpolicy/align.py"

"""STANDARD alignment contract for r2_ai_content_compliance_checker."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "r2_ai_content_compliance_checker"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/r2_ai_content_compliance_checker/align.py"

"""STANDARD alignment contract for r2_tool_risk_classifier."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "r2_tool_risk_classifier"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/r2_tool_risk_classifier/align.py"

"""STANDARD alignment contract for sanskrit_benchmark_lab."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "sanskrit_benchmark_lab"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/sanskrit_benchmark_lab/align.py"

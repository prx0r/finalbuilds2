"""STANDARD alignment contract for agentic_os_template."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "agentic_os_template"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/agentic_os_template/align.py"

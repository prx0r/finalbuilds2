"""STANDARD alignment contract for dynamodb.stream_abac_proof."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "dynamodb.stream_abac_proof"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/dynamodb.stream_abac_proof/align.py"

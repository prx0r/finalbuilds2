"""STANDARD alignment contract for r2_well_known_ai_index."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "r2_well_known_ai_index"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/r2_well_known_ai_index/align.py"

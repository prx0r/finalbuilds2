"""STANDARD alignment contract for r2_human_capability_ontology."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "r2_human_capability_ontology"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/r2_human_capability_ontology/align.py"

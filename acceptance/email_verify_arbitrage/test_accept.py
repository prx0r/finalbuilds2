"""STANDARD alignment contract for email_verify_arbitrage."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "email_verify_arbitrage"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/email_verify_arbitrage/align.py"

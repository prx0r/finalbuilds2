"""STANDARD alignment contract for x_evidence_graph."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "x_evidence_graph"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/x_evidence_graph/align.py"

"""STANDARD alignment contract for fi_webhookschemaguard."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "fi_webhookschemaguard"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/fi_webhookschemaguard/align.py"

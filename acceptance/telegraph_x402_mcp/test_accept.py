"""STANDARD alignment contract for telegraph_x402_mcp."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "telegraph_x402_mcp"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/telegraph_x402_mcp/align.py"

"""STANDARD alignment contract for r2_vent_cost_per_successful_task."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "r2_vent_cost_per_successful_task"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/r2_vent_cost_per_successful_task/align.py"

"""STANDARD alignment contract for x_probe_system."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "x_probe_system"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/x_probe_system/align.py"

"""STANDARD alignment contract for blueprint_app_foundry."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "blueprint_app_foundry"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/blueprint_app_foundry/align.py"

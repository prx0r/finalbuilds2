"""STANDARD alignment contract for cloudfront.oac_migration_equivalence."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "cloudfront.oac_migration_equivalence"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/cloudfront.oac_migration_equivalence/align.py"

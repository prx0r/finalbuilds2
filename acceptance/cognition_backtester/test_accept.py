"""STANDARD alignment contract for cognition_backtester."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "cognition_backtester"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/cognition_backtester/align.py"

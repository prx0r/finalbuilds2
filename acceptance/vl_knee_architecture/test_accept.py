"""STANDARD alignment contract for vl_knee_architecture."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "vl_knee_architecture"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/vl_knee_architecture/align.py"

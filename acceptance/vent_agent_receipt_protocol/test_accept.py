"""STANDARD alignment contract for vent_agent_receipt_protocol. Builder MUST NOT modify."""
import importlib.util, pathlib

ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "vent_agent_receipt_protocol"

def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/vent_agent_receipt_protocol/align.py"

"""STANDARD alignment contract for audio_actions."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "audio_actions"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/audio_actions/align.py"

"""STANDARD alignment contract for open_patala_graph."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "open_patala_graph"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/open_patala_graph/align.py"

"""STANDARD alignment contract for pronunciation_factory."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "pronunciation_factory"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/pronunciation_factory/align.py"

"""STANDARD alignment contract for fi_workspacequotarouter."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "fi_workspacequotarouter"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/fi_workspacequotarouter/align.py"

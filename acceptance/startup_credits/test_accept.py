"""STANDARD alignment contract for startup_credits."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "startup_credits"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/startup_credits/align.py"

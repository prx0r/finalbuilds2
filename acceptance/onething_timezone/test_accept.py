"""STANDARD alignment contract for onething_timezone."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "onething_timezone"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/onething_timezone/align.py"

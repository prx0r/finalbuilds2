"""STANDARD alignment contract for zerotrust.client_upgrade_gate."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "zerotrust.client_upgrade_gate"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/zerotrust.client_upgrade_gate/align.py"

"""STANDARD alignment contract for workload.jwt_audience_proof."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "workload.jwt_audience_proof"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/workload.jwt_audience_proof/align.py"

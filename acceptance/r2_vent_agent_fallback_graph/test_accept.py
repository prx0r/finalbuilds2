"""STANDARD alignment contract for r2_vent_agent_fallback_graph."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "r2_vent_agent_fallback_graph"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/r2_vent_agent_fallback_graph/align.py"

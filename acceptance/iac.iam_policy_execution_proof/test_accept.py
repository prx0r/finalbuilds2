"""STANDARD alignment contract for iac.iam_policy_execution_proof."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "iac.iam_policy_execution_proof"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/iac.iam_policy_execution_proof/align.py"

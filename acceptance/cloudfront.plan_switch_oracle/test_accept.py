"""STANDARD alignment contract for cloudfront.plan_switch_oracle."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "cloudfront.plan_switch_oracle"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/cloudfront.plan_switch_oracle/align.py"

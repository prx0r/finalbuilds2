"""STANDARD alignment contract for dynamodb.extenddb_parity."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "dynamodb.extenddb_parity"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/dynamodb.extenddb_parity/align.py"

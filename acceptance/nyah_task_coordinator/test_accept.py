"""STANDARD alignment contract for nyah_task_coordinator."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "nyah_task_coordinator"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/nyah_task_coordinator/align.py"

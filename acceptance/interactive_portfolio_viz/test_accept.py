"""STANDARD alignment contract for interactive_portfolio_viz."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "interactive_portfolio_viz"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/interactive_portfolio_viz/align.py"

"""STANDARD alignment contract for resume_tailor."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "resume_tailor"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/resume_tailor/align.py"

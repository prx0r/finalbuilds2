"""STANDARD alignment contract for r2_ai_crawler_policy_monitor."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "r2_ai_crawler_policy_monitor"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/r2_ai_crawler_policy_monitor/align.py"

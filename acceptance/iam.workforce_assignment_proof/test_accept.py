"""STANDARD alignment contract for iam.workforce_assignment_proof."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "iam.workforce_assignment_proof"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/iam.workforce_assignment_proof/align.py"

"""STANDARD alignment contract for r2_proof_of_physical_work."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "r2_proof_of_physical_work"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/r2_proof_of_physical_work/align.py"

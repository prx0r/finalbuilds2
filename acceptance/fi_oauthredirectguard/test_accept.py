"""STANDARD alignment contract for fi_oauthredirectguard."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "fi_oauthredirectguard"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/fi_oauthredirectguard/align.py"

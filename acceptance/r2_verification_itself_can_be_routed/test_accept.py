"""STANDARD alignment contract for r2_verification_itself_can_be_routed."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "r2_verification_itself_can_be_routed"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/r2_verification_itself_can_be_routed/align.py"

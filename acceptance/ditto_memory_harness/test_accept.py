"""STANDARD alignment contract for ditto_memory_harness."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "ditto_memory_harness"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/ditto_memory_harness/align.py"

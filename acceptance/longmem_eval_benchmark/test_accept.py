"""STANDARD alignment contract for longmem_eval_benchmark."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "longmem_eval_benchmark"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/longmem_eval_benchmark/align.py"

"""STANDARD alignment contract for machine_work_exchange."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "machine_work_exchange"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/machine_work_exchange/align.py"

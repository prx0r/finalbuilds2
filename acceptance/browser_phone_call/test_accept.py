"""STANDARD alignment contract for browser_phone_call."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "browser_phone_call"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/browser_phone_call/align.py"

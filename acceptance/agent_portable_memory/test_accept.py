"""STANDARD alignment contract for agent_portable_memory."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "agent_portable_memory"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/agent_portable_memory/align.py"

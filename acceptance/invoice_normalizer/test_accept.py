"""STANDARD alignment contract for invoice_normalizer."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "invoice_normalizer"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/invoice_normalizer/align.py"

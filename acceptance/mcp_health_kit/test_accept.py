"""STANDARD alignment contract for mcp_health_kit."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "mcp_health_kit"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/mcp_health_kit/align.py"

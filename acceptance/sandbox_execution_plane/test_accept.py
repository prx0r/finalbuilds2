"""STANDARD alignment contract for sandbox_execution_plane."""
import importlib.util, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]
PROD = ROOT / "platform" / "products" / "sandbox_execution_plane"
def _load():
    p = PROD / "align.py"
    assert p.exists(), f"missing platform/products/sandbox_execution_plane/align.py"
